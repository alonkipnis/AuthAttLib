...
In order to use AuthorshipAttributionMulti* arrange input data in a pandas dataframe with columns 
> <author>|<doc_id>|<text> 
all of which are strings. 

See 'AuthorshipAttribution_example.ipynb' for usage in authorship attribution challenges. 

This code was used to get the resutls in [this](https://web.stanford.edu/~kipnisal/authorship.html) page and the the paper:
